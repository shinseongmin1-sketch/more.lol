...
export const ITEMS = {
  ...
  spellthiefs:    { id:'3850', name:'요술사의 칼날' },
  relicShield:    { id:'3858', name:'성물 방패' },
  steelcaps:      { id:'3047', name:'강철 발목 보호대' },
  mercTreads:     { id:'3111', name:'마법 저항력 신발' },
  ...
  sunfire:        { id:'3068', name:'쐐기불꽃 방패' },
  heartsteel:     { id:'3441', name:'심장강철' },
  frozenHeart:    { id:'3110', name:'얼어붙은 심장' },
  locketSolari:   { id:'3190', name:'철의 솔라리 상징' },
  // 원딜
  infinityEdge:   { id:'3031', name:'무한의 대검' },
  bork:           { id:'3153', name:'몰락한 왕의 검' },
  kraken:         { id:'6672', name:'크라켄 학살자' },
  // AP
  ludens:         { id:'6655', name:'루덴의 동반자' },
  shadowflame:    { id:'4645', name:'그림자 불꽃' },
  rabadons:       { id:'3089', name:'라바돈의 죽음 모자' },
  voidStaff:      { id:'3135', name:'공허 지팡이' },
  zhonyas:        { id:'3157', name:'조냐의 모래시계' },
  // 서포터
  moonstone:      { id:'6617', name:'달빛 돌' },
  ardentCenser:   { id:'3504', name:'열의의 향로' },
  staffFlowing:   { id:'6616', name:'흐르는 물의 지팡이' },
  redemption:     { id:'3107', name:'구원' },
...
export const TEMPLATES: Record<RoleName, BuildTemplate> = {
  ...
  tank: {
    ...
    startItems: [ITEMS.doranShield, ITEMS.hpPotion],
    boots: ITEMS.steelcaps,
    coreItems: [ITEMS.sunfire, ITEMS.heartsteel, ITEMS.deadMan],
    fullBuild: [ITEMS.steelcaps, ITEMS.sunfire, ITEMS.heartsteel, ITEMS.deadMan, ITEMS.frozenHeart, ITEMS.warmog],
    skillMaxOrder: ['W','E','Q'],
  },
  ...
  mage: {
    ...
    coreItems: [ITEMS.ludens, ITEMS.shadowflame, ITEMS.rabadons],
    fullBuild: [ITEMS.sorcShoes, ITEMS.ludens, ITEMS.shadowflame, ITEMS.rabadons, ITEMS.voidStaff, ITEMS.zhonyas],
    skillMaxOrder: ['Q','W','E'],
  },
  ...
  assassin: {
    ...
    boots: ITEMS.steelcaps,
    coreItems: [ITEMS.youmuus, ITEMS.serpentsFang, ITEMS.deadMan],
    fullBuild: [ITEMS.steelcaps, ITEMS.youmuus, ITEMS.serpentsFang, ITEMS.deadMan, ITEMS.blackCleaver, ITEMS.guardianAngel],
    skillMaxOrder: ['Q','E','W'],
  },
  ...
  marksman: {
    ...
    coreItems: [ITEMS.kraken, ITEMS.infinityEdge, ITEMS.bork],
    fullBuild: [ITEMS.berserkers, ITEMS.kraken, ITEMS.infinityEdge, ITEMS.bork, ITEMS.mortalReminder, ITEMS.guardianAngel],
    skillMaxOrder: ['Q','W','E'],
  },
  ...
  supportEnchant: {
    ...
    secondaryRune1: RUNES.biscuit, secondaryRune2: RUNES.cosmicInsight,
    shardOff: STAT_SHARDS.adaptive, shardFlex: STAT_SHARDS.adaptive, shardDef: STAT_SHARDS.health,
    startItems: [ITEMS.spellthiefs, ITEMS.hpPotion],
    boots: ITEMS.ionianBoots,
    coreItems: [ITEMS.moonstone, ITEMS.ardentCenser, ITEMS.staffFlowing],
    fullBuild: [ITEMS.ionianBoots, ITEMS.moonstone, ITEMS.ardentCenser, ITEMS.staffFlowing, ITEMS.redemption, ITEMS.shurelyas],
    skillMaxOrder: ['E','Q','W'],
  },
  ...
  supportTank: {
    ...
    secondaryRune1: RUNES.biscuit, secondaryRune2: RUNES.cosmicInsight,
    shardOff: STAT_SHARDS.armor, shardFlex: STAT_SHARDS.armor, shardDef: STAT_SHARDS.health,
    startItems: [ITEMS.relicShield, ITEMS.hpPotion],
    boots: ITEMS.ionianBoots,
    coreItems: [ITEMS.locketSolari, ITEMS.frozenHeart, ITEMS.heartsteel],
    fullBuild: [ITEMS.ionianBoots, ITEMS.locketSolari, ITEMS.frozenHeart, ITEMS.heartsteel, ITEMS.redemption, ITEMS.warmog],
    skillMaxOrder: ['W','E','Q'],
  },
  ...
  jungler: {
    ...
    fullBuild: [ITEMS.steelcaps, ITEMS.blackCleaver, ITEMS.deadMan, ITEMS.warmog, ITEMS.mortalReminder, ITEMS.guardianAngel],
    skillMaxOrder: ['Q', 'E', 'W'],
  },
}
